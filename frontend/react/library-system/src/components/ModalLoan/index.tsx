...
export const ModalLoan = ({ book }: IModalBook) => {
  return (
    <>
      ...
      <div className='flex flex-col w-[95%] h-full m-2'>
        ...
        <div className='h-16 w-full flex items-center justify-center gap-4 mb-5 mt-3'>
          <button className='w-2/5 p-3 rounded text-white font-semibold bg-pink-400 cursor-pointer transition-colors hover:bg-pink-500'>
